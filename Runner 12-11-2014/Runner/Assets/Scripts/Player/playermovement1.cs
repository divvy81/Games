...
public class playermovement1 : MonoBehaviour 
{
	...
	void Start()
	{
		...
		min = 0;
		hrs = 0;
		max_distance_before_speed_upgrade = settttings.distance_after_speed_changes;
		anim = this.gameObject.GetComponent<Animator>();
		anim.speed = settttings.speed;
...
*/
	...
	void OnGUI()
	{
		...
		GUI.Box(new Rect(0, Screen.height - 120,240,55), "", GUI.skin.FindStyle("Box"));
		
		//GUI.Label (new Rect(100, Screen.height - 50,100,400), "" + Mathf.Round(speed) , style1);
		//Debug.Log ("value of speed is " + speed);
		GUI.Label (new Rect(40, Screen.height - 50,100,400),"KM/H : " + anim.speed*10, style1);
